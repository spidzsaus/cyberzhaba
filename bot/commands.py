...
async def barrel_organ(msg):
    ...
    if not barrellorgan:
        embed = basic_embed(title='Увы, у тебя нет шарманки',
    ...
    if voice_channel != None:
        ...
        voice_client.play(discord.FFmpegPCMAudio(source=os.path.join(barrellorgan.path, 'melody.mp3'),
